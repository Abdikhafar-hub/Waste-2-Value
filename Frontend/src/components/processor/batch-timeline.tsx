...
import { type ProcessorTimelineItem } from "@/types/processor";

export function BatchTimeline({ items }: { items: ProcessorTimelineItem[] }) {
  return (
          ...
          <div key={item.id} className="relative flex gap-3">
            ...
            <div className="pb-1">
              ...
              <p className="text-xs text-muted-foreground">
                {item.status.replaceAll("_", " ")} • {formatDateTime(item.at)} • {item.actor}
              </p>
