...
export default function ProcessorAccountPage() {
  const profile = useAsyncResource(() => processorService.getAccountProfile(), []);

  return (
    <div className="space-y-4">
      <PageHeader
        title="Account"
        description="Personal profile, role context, and processor security settings."
      />
        ...
        <>
          <SectionCard title={`${profile.data.firstName} ${profile.data.lastName}`} subtitle={profile.data.email}>
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <StatBlock label="Center" value={profile.data.processingCenter} />
          ...
          <section className="grid gap-4 lg:grid-cols-2">
            <SectionCard title="Security" subtitle="Authentication and account protection" compact>
            ...
            <SectionCard title="Preferences" subtitle="Workspace settings and notifications" compact>
              <div className="rounded-lg border border-border p-3">
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Batch and assignment alerts placeholder</p>
                    </div>
                  </div>
